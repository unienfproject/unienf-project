...
export function AuthBranding({ title, subtitle }: AuthBrandingProps) {
  return (
    <div className="from-primary via-primary/90 to-primary/80 relative hidden flex-col items-center justify-between overflow-hidden bg-gradient-to-br p-12 lg:flex lg:w-1/2">
